    ...
    return (
        <section className={classes.FooterWrapper}>
            ...
            <div className={classes.Footer} >
                ...
                <div id='contact' className={classes.FooterText}>
                    
                    <div>
                        <ContactForm />
                        <div className={classes.ContactDetails}>
                            <p>Address: lorem yada yada 123 place, Nigeria</p>
                            <p>Want to talk to us? <a href='tel:08165520839'>Click to call</a></p>
                        </div>
                        <p className={classes.Copyright}>&copy; 2022, spicysoups.com. All rights reserved</p>
                    </div>
                </div>
